        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-4 col-md-12">
                <div class="login_form">
                    ...
                    // }
                    // if(!empty($loginerror)) {
                    //     echo '<p class="errmsg">Invalid login credential, Please try again</p>';
                    // }
                    ?>

                    <form action="login_process.php" method="POST">
                        <div class="form-group">
                            <label class="form-label label_text">Username or Email</label>
                    ...
                    <p class="forgot_pass"><a href="forgot_pass.php">Forget password?</a></p><br>

                    
                    <p class="dont_acc">Dont Have an account? <a href="signup.php">Sign up</a></p>
                </div>    
            </div>
            <div class="col-sm-4">  
